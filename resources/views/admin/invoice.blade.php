                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="icons Feather Fontawsome flag material simple line themify" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class=""><a href="icon-fontawsome.html" class="">Fontawsome 5<span class="pcoded-badge label label-primary">1000+</span></a></li>
                    ...
                    <li data-username="Charts AM Chart js Echart Google Highchart Knob Morris Nvd3 Peity Radial" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="chart-am.html" class="">Am chart 4</a></li>
                    ...
                    <!-- <li data-username="Editor CK-Editor Tinemce" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class=""><a href="editor-tinymce.html" class="">Tinemce editor</a></li>
                        </ul>
                    </li> -->
                    <li data-username="Invoice Summury List" class="nav-item pcoded-hasmenu active pcoded-trigger">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="active"><a href="invoice.html" class="">Invoice</a></li>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('dattaAble/assets/images/user/avatar-1.jpg')}}" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('dattaAble/assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image">
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('dattaAble/assets/images/user/avatar-3.jpg')}}" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{asset('dattaAble/assets/images/user/avatar-1.jpg')}}" class="img-radius" alt="User-Profile-Image">
                                <span>John Doe</span>
            ...
            <div class="main-friend-cont scroll-div">
                <div class="main-friend-list">
                    <div class="media userlist-box  " data-id="1" data-status="online" data-username="Josephin Doe">
                        <a class="media-left" href="javascript:"><img class="media-object img-radius" src="{{asset('dattaAble/assets/images/user/avatar-1.jpg')}}" alt="Generic placeholder image ">
                    ...
                    <div class="media userlist-box  " data-id="2" data-status="online" data-username="Lary Doe">
                        <a class="media-left" href="javascript:"><img class="media-object img-radius" src="{{asset('dattaAble/assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image">
                    ...
                    <div class="media userlist-box  " data-id="3" data-status="online" data-username="Alice">
                        <a class="media-left" href="javascript:"><img class="media-object img-radius" src="{{asset('dattaAble/assets/images/user/avatar-3.jpg')}}" alt="Generic placeholder image"></a>
                        <div class="media-body">
                    ...
                    <div class="media userlist-box  " data-id="5" data-status="offline" data-username="Suzen">
                        <a class="media-left" href="javascript:"><img class="media-object img-radius" src="{{asset('dattaAble/assets/images/user/avatar-4.jpg')}}" alt="Generic placeholder image"></a>
                        <div class="media-body">
            ...
            <div class="main-chat-cont scroll-div">
                <div class="main-friend-chat">
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="javascript:"><img class="media-object img-radius img-radius m-t-5" src="{{asset('dattaAble/assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image"></a>
                                                    ...
                                                    <div class="invoice-box row">
                                                        <div class="col-sm-12">
                                                            <table class="table table-responsive invoice-table table-borderless">
                                                                <tbody>
                                                                    <tr>
                                                                        <td><img src="{{asset('dattaAble/assets/images/logo-dark.png')}}" class="m-b-10" alt=""></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Company name </td>
                                                                    </tr>
