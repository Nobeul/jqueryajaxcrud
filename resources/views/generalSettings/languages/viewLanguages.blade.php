    ...
    <div class="row">
        <div class="col-md-3 col-sm-12">
            <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <li {{(request()->path() == 'admin/generalsettings/languages/') ? 'class="active"' : null}} @php if('class=="active"'){
                echo ' style="background-color:#3490dc;';
                echo 'border-radius: 0.25rem;"';
                }
            @endphp><a class="nav-link text-left" id="v-pills-profile-tab" href="{{route('language.viewlist')}}" style="@php if(' class=="active"') echo ' color:#fff';@endphp">Languages</a></li>
        ...
        <div class="col-md-9 col-sm-12">
            <div class="tab-content" id="v-pills-tabContent">
                <div>
                    <b style="margin:-12px; font-size:20px">General Settings >> Languages</b>
                            ...
                            <table id="fixed-columns-left" class="table table-striped table-hover table-bordered nowrap" style="width:725px;">
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{$language->id}}">
                                        ...
                                        <td>
                                            <a type="button" style="border: 1px solid #4498de" class="editDepartment" id="{{$language->id}}"><i class="feather icon-edit" style="padding:4px"></i></a>
                                            <button title="Delete" class="delete" data-id="3" id="{{$language->id}}" type="submit" data-label="Delete" data-toggle="modal" data-target="#confirmDelete" data-title="Delete Location" data-message="Are you sure you want to delete this Department ?" style="border: 1px solid red;height: 23px;padding-top: 0px;">
        ...
        <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="modalForm" method="POST" action="{{route('language.addNew')}}">
                        @csrf()
                        <div class="modal-body">
                            ...
                            <div class="form-group row p-t-10">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="name" name="language_name" placeholder="Name">
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="modalForm1" method="post" action="{{route('language.update')}}">
                        @csrf()
                        <div class="modal-body">
                            ...
                            <div class="form-group row p-t-10">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="editName" name="language_name" placeholder="Name">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    ...
    $(document).on('click', '.delete', function() {
        ...
        if (confirm("Are you sure you want to Delete this data?")) {
            $.ajax({
                type: "post",
                url: "/admin/generalsettings/languages/deletelanguage/" + id,
                data: {
                    "id": id,
                    "_token": "{{ csrf_token() }}"
                },
    ...
    $('.editDepartment').on('click', function() {
        ...
        $.ajax({
            type: "get",
            url: "/admin/generalsettings/languages/editlanguage/" + id,
            data: {
                "id": id,
            },
            dataType: 'json',
            success: function(data) {
                ...
                $('#modal1').modal();
                $('#editName').val(data.language_name);
            }
        })
    });
</script>
